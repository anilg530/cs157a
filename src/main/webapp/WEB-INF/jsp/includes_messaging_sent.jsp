...
<div class="col-xs-12">
    <div class="table-responsive no-wrap-xs">
        <table class="table table-striped">
            ...
            <% ArrayList<ArrayList<String>> received_messages_array = MessagingModel.getAllSentMessages(Integer.toString((int) session.getAttribute("user_id")));
                if (!received_messages_array.isEmpty()) {
                    for (ArrayList<String> single_message : received_messages_array) {
                        ...
                        String send_to_user_id = single_message.get(1);
            ...
            %>
            <tr class="cursor-hand" data-attr="<% out.print(send_to_user_id); %>" onclick="filehub_send_message(this);">
